...
function App() {
  //the api key was stored in a .env file and referenced in the code using import.meta.env that has the api key as one of it's properties
  ...
  const getWeather = (event) => {
    //the if statement checks if the keyboard event equals the enter key then the data for a specific city is fetched from the weather api
    if (event.key === "Enter") {
      fetch(
